...
public class MainEmployee {
    ...
    public static void main(String[] args) {
        Manager manager = new Manager("Muhammad Bagas Firmansyah");
        Developer developer = new Developer("Muhammad Bagas Firmansyah");
        Designer designer = new Designer("Muhammad Bagas Firmansyah");
